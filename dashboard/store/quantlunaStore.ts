/**
 * QuantLuna Global State Store (Zustand)
 * Connects to: execution/pnl_reconciler.py, strategy/regime_filter.py,
 *              core/spread_monitor.py, execution/order_manager.py,
 *              risk/circuit_breaker.py, execution/health_check.py
 */
